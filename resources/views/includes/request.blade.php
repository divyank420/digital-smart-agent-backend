<div id="requestModal" class="modal-back" onclick="if(event.target===this)closeRequestModal()">
    <div class="modal-panel p-5 sm:p-7 md:p-9">
        ...
        <div class="flex items-center gap-1.5 sm:gap-3 mt-5 sm:mt-6 mb-5 sm:mb-6">
            <div class="flex items-center gap-2"><span id="dot1"
                    class="step-dot gradient-bg text-white">1</span><span
        ...
        <div id="step2" class="hidden space-y-4">
            <div class="rounded-2xl p-5 bg-gradient-to-br from-slate-50 to-white border border-slate-200 text-center">
                <div
                    class="w-14 h-14 rounded-full gradient-bg text-white flex items-center justify-center mx-auto text-xl">
                ...
                <div class="flex justify-center flex-wrap gap-1.5 sm:gap-2 mt-5" id="otpWrap">
                    <input class="otp-box" maxlength="1" /><input class="otp-box" maxlength="1" /><input
        ...
        <div id="step3" class="hidden space-y-4">
            <div class="grid sm:grid-cols-2 gap-4">
                <div><label class="fld-label">Total DOP Agents</label><input id="rf_dop" type="number"
                        min="1" class="fld" placeholder="e.g. 5" /></div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="mt-2 flex items-center gap-2">
                                    ...
                                    <select id="pl_agent_qty" class="fld !py-1.5 !text-xs w-auto"
                                        onchange="calcTotal()">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
