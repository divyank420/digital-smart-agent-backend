...
<div class="container-fluid">
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="border rounded p-2 mb-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-muted">
                                    Position: <strong>{{ ucfirst($msg->position ?? 'Top') }}</strong>
                                    | Status: <span class="{{ $msg->is_active ? 'text-success' : 'text-danger' }}">
                            ...
                            <div>
                                <button class="btn btn-sm btn-primary"
                                    onclick='editPromotion(@json($msg))'>
                                    Edit
                                </button>
                                <form action="{{ route('agent.promotions.destroy', $msg->id) }}"
                                    method="POST"
                        ...
                        <p class="mt-2 mb-0">{!! nl2br(e($msg->message)) !!}</p>
                    </div>
                    @endforeach
                </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <strong id="formTitle">Add Promotional Message</strong>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('agent.promotions.store') }}" id="promoForm" data-validation="validate">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-success" onclick="formValidation('promoForm','submit')">
                                Save
                            </button>
