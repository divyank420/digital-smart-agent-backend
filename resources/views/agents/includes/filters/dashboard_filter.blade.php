                    ...
                    <div class="row row-cols-lg-2 row-cols-xl-auto g-2">
                        <div class="col">
                            <div class="position-relative">
                                <input type="text" class="form-control ps-5" placeholder="Search Product..."> <span class="position-absolute top-50 search-icon translate-middle-y"><i class="bx bx-search"></i></span>
                            </div>
                        </div>
                        <div class="col">
